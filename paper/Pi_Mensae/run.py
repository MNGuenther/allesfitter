...
# allesfitter.mcmc_fit('allesfit_0')
# allesfitter.mcmc_output('allesfit_0')
...
# allesfitter.show_initial_guess('allesfit_3')
# allesfitter.ns_fit('allesfit_3')
# allesfitter.ns_output('allesfit_3')


# allesfitter.estimate_noise_out_of_transit('allesfit_4')
