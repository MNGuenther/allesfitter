...
def fullplot(time, y, yerr=None, ax=None, time_format='BJD_TDB'):
    '''
    Parameters
    ----------
    time : TYPE
    ...
    plt.errorbar(time, y, yerr=yerr, fmt='b.', ms=2)
...
def tessplot(time, y, yerr=None, time_format='BJD_TDB'):
    '''
    ...
    fig, axes = plt.subplots(N, figsize=(12,3*N), tight_layout=True)
